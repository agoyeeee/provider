    ...
    <div
        ...
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="text-center">
                <div
                    class="mx-auto h-16 w-16 bg-gradient-to-r from-green-500 to-blue-600 dark:from-green-400 dark:to-blue-500 rounded-full flex items-center justify-center mb-6 shadow-lg">
            ...
            <div class="bg-card shadow-xl rounded-2xl p-8 border border-border">
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <TextInput id="email" type="email"
                                class="mt-1 block w-full px-4 py-3 border border-input rounded-xl focus:ring-2 focus:ring-ring focus:border-ring transition-all duration-200 bg-background text-foreground placeholder:text-muted-foreground"
                                v-model="form.email" required autocomplete="username" placeholder="Enter your email" />
                            <div class="absolute inset-y-0 right-0 pr-3 flex items-center">
                                <svg class="h-5 w-5 text-muted-foreground" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <TextInput id="nik" type="text"
                                class="mt-1 block w-full px-4 py-3 border border-input rounded-xl focus:ring-2 focus:ring-ring focus:border-ring transition-all duration-200 bg-background text-foreground placeholder:text-muted-foreground"
                                v-model="form.nik" required autocomplete="off" placeholder="Enter your NIK (16 digits)"
